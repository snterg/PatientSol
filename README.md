...
4. [API Методы](#api-методы)
    ...
    - [FHIR-форматы поиска](#форматы-поиска)
...
9. [Postman коллекция](#postman-коллекция)
    ...
    - [Поиск по дате рождения](#поиск-по-дате-рождения)
...
15. [Используемые технологии проекта](#используемые-технологии-проекта)
...
для GET /api/patients/search в формате FHIR (https://www.hl7.org/fhir/search.html#date)
...
### Запуск PatientConsoleApplication
```bash
cd PatientConsoleWithoutDocker
dotnet run
```
