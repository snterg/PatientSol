...
GET	/api/patients/valid-values	Получение справочников и версии API
...
Справочники: gender, active

Длина полей: защита от DoS-атак

Формат данных: FHIR для дат, regex для имен

Логические проверки: дата не в будущем, возраст не более 150 лет
